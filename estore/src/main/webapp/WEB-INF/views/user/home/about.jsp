...
<div id="mainBody">
		<div class="row">
			<div class="span9" id="mainCol">
				...
				<p>- Bạn đăt hàng trên Web → Nhân viên Website sẽ gọi điện thoại
					xác nhận đơn hàng của bạn → Giao hàng và Thu tiền tận nơi trên toàn
					quốc.</p>
				<br>

				<h4>2. Thời gian mở cửa tại các Shop của Website</h4>
				<p>- Các shop của Website mở cửa từ 8h tới 21h tất cả các ngày,
					kể cả thứ 7 và Chủ Nhật</p>
				<br>

				<h4>3. Có phải đặt hàng online trên trang website trước khi đến
					các Shop của Website hay không?</h4>
				<p>- Website có đầy đủ các mặt hàng mà trên website bán, bạn có
					thể tới trực tiếp mua hàng không cần đặt trước trên website</p>
				<br>

				<h4>4. Mua tại các shop của Website có nhận được tiền tích lũy
					không ?</h4>
				<p>- Tiền tích lũy chỉ áp dụng cho các thành viên của Website
					Website mua hàng online bạn nhé.</p>
				<br>

				<h4>5. Giá các sản phẩm tại các shop Website có giống giá trên
					Website Website không ?</h4>
				<p>- Tất cả sản phẩm trên Website Website bán giống giá với tất
					cả các hệ thống Shop của Website.</p>
				<br>
				...
				<p>- Tất cả các mặt hàng tại Website có dịch vụ giao hàng miễn
				...
				<p>- Bạn trở thành khách hàng thân thiện sẽ được tham gia miễn
					phí tất cả các chương trình giảm giá của Website và còn được giảm
				...
				<h4>15. Sản phẩm bên ngoài có giống trong hình trên Website
					không?</h4>
				<p>- Sản phẩm được Website được đặt riêng với tiêu chí chất
					lượng đặt lên hàng đầu, tiếp đến là mẫu mã đa dạng đẹp và giống
					hình ảnh cung cấp bạn nhé.</p>
				<br>
